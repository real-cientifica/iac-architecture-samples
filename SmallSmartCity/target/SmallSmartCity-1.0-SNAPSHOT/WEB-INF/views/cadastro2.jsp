                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <table class="table table-hover table-dark">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">vm tcc</th>
                                    <td>ao vivo</td>
                                    <td>Linux 8</td>
                                    <td>VM.Standard 2.16</td>
                                    <td><a onclick="swal('Sucesso!','Máquina virtual destruida com sucesso!', 'success')" href="/destruir"><button class="btn btn-danger">X</button></a></td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" type="text" name="so" id="so">
                                        ...
                                        <option value="Rede.1v5">Rede 1v5</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" type="text" name="shape" id="shape">
                                        ...
                                        <option value="VM.Standard2.8">VM.Standard 2.16</option>
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-primary" onclick="alertaVmCriada()" href="/criar?shape=VM.Standard2.2">Salvar</a>
                            </div>
                        </div>
                        <script>
                            function alertaVmCriada()
                            {
                    ...
                    <div class="modal fade" id="bsModal3" tabindex="-1" role="dialog" aria-labelledby="bsModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                                    <button type="button" class="btn btn-primary">Salvarca</button>
                                </div>
                            </div>
                        </div>
                    </div>
